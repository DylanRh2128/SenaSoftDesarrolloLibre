...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Visualiza, edita o crea nuevas reservas fácilmente</p>
        </div>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-muted py-4">
                                        <i class="bi bi-exclamation-circle me-2"></i>No hay reservas registradas.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <form action="../../src/admin/crear-reservas.php" method="post" class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <select name="idDisponibilidad" class="form-select" required>
                            <option value="">Seleccione disponibilidad</option>
                            <?php foreach ($disps as $d): ?>
                                <option value="<?= htmlspecialchars($d['idDisponibilidad']) ?>">
                                    <?= htmlspecialchars($d['fecha'] . ' - ' . $d['origen'] . ' → ' . $d['destino']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <select name="idPasajeros" class="form-select" required>
                            <option value="">Seleccione pasajero</option>
                            <?php foreach ($pasajeros as $p): ?>
                                <option value="<?= htmlspecialchars($p['idPasajero']) ?>">
                                    <?= htmlspecialchars($p['nombres'] . ' ' . $p['primerApellido']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
